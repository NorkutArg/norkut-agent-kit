...
warn(`contract-guard: ${basename(file)} es parte del contrato de \`${event}\`, que tiene copias en otros repos. Solo cambios aditivos: propiedades nuevas nullable y sin \`required\`; no renombrar el tipo, el namespace \`IntegrationEvents.Events\` ni el \`EndpointName\`. Antes de seguir, listar productores y consumidores (\`nk-event-contract\` o \`event-contracts.md\` de norkut-core).`);
